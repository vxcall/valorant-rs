...
pub struct SelectCharacterResponse {
    ...
    pub observer_subjects: Vec<serde_json::Value>, // unknown types as flexible JSON
    pub match_coaches: Vec<serde_json::Value>, // unknown types as flexible JSON
